...
from utils.circle_hard_data import calculate_score_per_domain, MultiDomainDatasetTrain, SingleDomainDatasetTest
...
data_dir = 'datasets/processed_data/circle_hard'
...
out_dir = 'saved_model/circle_hard/stream'
...
out_dir = 'output/circle_hard/stream'
if not os.path.exists(out_dir):
    os.makedirs(out_dir)
